...
def run(A,T,L,N_IT,N_S):
    ...
    path = 'data/log12/t' + '_'+ str(L) + '_' + str(A) + '_' + str(N_IT) + '_' + str(N_S)
    print(path)
    gs.run(out='data/log12/t' + '_'+ str(L) + '_' + str(A) + '_' + str(N_IT) + '_' + str(N_S), 
...
for N_IT in NN_IT:
    for N_S in NN_S:
        for L in LL:
            for A in range (I,360,1):
                df = main(A,T,L,N_IT,N_S)
                path_df = 'data/df12/t' + '_'+ str(L) + '_' + str(A) + '_' + str(N_IT) + '_' + str(N_S) + '.csv'
