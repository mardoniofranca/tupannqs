...
def calc_exac_lanczos_ed(op,L,wT,data_path):
    ...
    e_path = data_path + "/exact_" + str(L)  + "_"  + str(wT) +  ".csv"
...
it = 10; L = 8; wTs = [30,45,60,210,225,300,315,330]; L_E = 30; key_exec = 0

#for wT in range(I_W,L_W):

for wT in wTs:
    key_exec = 0
    for e in range(1,L_E):
        print(wT,e)
        data_path = "data/test/exec_" + digts(e);  run_id    = digts(e)
